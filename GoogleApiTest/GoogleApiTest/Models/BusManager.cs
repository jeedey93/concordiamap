...
namespace GoogleApiTest
{
	public class BusManager
	{
		...
		public List<String> InitializeLOYBusMonThur(){
			...
			LOYBusMonThur.Add ("11:35");
			LOYBusMonThur.Add ("11:55");
			LOYBusMonThur.Add ("12:15");
			LOYBusMonThur.Add ("12:15");
			LOYBusMonThur.Add ("12:35");
			LOYBusMonThur.Add ("12:55");
			LOYBusMonThur.Add ("13:15");
			LOYBusMonThur.Add ("13:35");
			LOYBusMonThur.Add ("13:55");
			LOYBusMonThur.Add ("14:15");
			LOYBusMonThur.Add ("14:35");
			LOYBusMonThur.Add ("14:55");
			LOYBusMonThur.Add ("15:15");
			LOYBusMonThur.Add ("15:35");
			LOYBusMonThur.Add ("15:55");
			LOYBusMonThur.Add ("16:15");
			LOYBusMonThur.Add ("16:35");
			LOYBusMonThur.Add ("16:55");
			LOYBusMonThur.Add ("17:15");
			LOYBusMonThur.Add ("17:35");
			LOYBusMonThur.Add ("17:55");
			LOYBusMonThur.Add ("18:15");
			LOYBusMonThur.Add ("18:35");
			LOYBusMonThur.Add ("18:55");
//			LOYBusMonThur.Add ("From 11:30 to 19:00\n\nA bus leaves each campus every 20 – 25 minutes.");
		...
		public List<String> InitializeSGWBusMonThur(){
			...
			SGWBusMonThur.Add ("12:00");
			SGWBusMonThur.Add ("12:20");
			SGWBusMonThur.Add ("12:40");
			SGWBusMonThur.Add ("13:00");
			SGWBusMonThur.Add ("13:20");
			SGWBusMonThur.Add ("13:40");
			SGWBusMonThur.Add ("14:00");
			SGWBusMonThur.Add ("14:20");
			SGWBusMonThur.Add ("14:40");
			SGWBusMonThur.Add ("15:00");
			SGWBusMonThur.Add ("15:20");
			SGWBusMonThur.Add ("15:40");
			SGWBusMonThur.Add ("16:00");
			SGWBusMonThur.Add ("16:20");
			SGWBusMonThur.Add ("16:40");
			SGWBusMonThur.Add ("17:00");
			SGWBusMonThur.Add ("17:20");
			SGWBusMonThur.Add ("17:40");
			SGWBusMonThur.Add ("18:00");
			SGWBusMonThur.Add ("18:20");
			SGWBusMonThur.Add ("18:40");
